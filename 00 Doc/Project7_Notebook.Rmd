...
![](../03 Visualizations/ScatterFemalePassRateWest.png)

![](../03 Visualizations/ScatterFemalePassRateSouth.png)
![](../03 Visualizations/ScatterFemalePassRateNortheast.png)
![](../03 Visualizations/ScatterFemalePassRateMidwest.png)

> **Insight for Figure 3 - 6: *Female Pass Rate Related to Student Teacher Ratio by Region* **  
This scatterplot demonstrates the relationship between the yield per teacher which means the number of students per teacher teaches and the female pass rate. We made scatterplot for each region, Midwest, Northeast, South and West. The line in each page is the trend line for the female pass rate in each region. 

> In Midwest and Northeast, the female pass rates tend to decrease as the number of students each teacher has increases. For South region, the female pass rate is moderately related with the yield per teacher. However, in West region, with a higher yield per teacher, the female pass rate would be higher. 
...
> **Insight for Figure 10: *Map of Taking Rate for Hispanic* **  
...
> **Insight for Figure 11: *Map of Taking Rate for Blacks* **  
